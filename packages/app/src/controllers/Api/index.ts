...
export class ApiController {
  // ------------------------------------------------------
  // Class members - Tangle Network API instances
  // ------------------------------------------------------
  ...
  // ------------------------------------------------------
  // Instance methods for Tangle Network
  // ------------------------------------------------------

  // Instantiate a new `Api` instance with the supplied owner, chainId and endpoint.
  // For Tangle Network, chainId will be either 'tangle' or 'tangle-testnet'
  static async instantiate(
    chainSpaceId: ChainSpaceId,
    ownerId: OwnerId,
    chainId: ChainId,
    ...
    // Validate if endpoint is a valid Tangle RPC endpoint
    if (!endpoint.includes('tangle')) {
      console.warn('Warning: Non-Tangle RPC endpoint detected');
    }
  ...
  // Returns Substrate API instance by default, or Observable client if `observable` is true.
  static getInstanceApi(
    ownerId: OwnerId,
    instanceIndex: number,
    observable = false
